 ...
 const Skill = () => {  
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen -mt-20  ">
      <p className="text-center mb-2 text-black lg:mt-0 -mt-2 ">
      ...
      <div className="flex justify-center space-x-2 mb-8 font-bold text-blue-900">
        <span className="text-center">Web Developer with</span>
        <span className="text-center">UI/UX Design Skill</span>
      </div>
      <div className="grid grid-cols-4 md:grid-cols-4 gap-8 mb-8 bg-black bg-opacity-25 text-black rounded-lg p-4">
